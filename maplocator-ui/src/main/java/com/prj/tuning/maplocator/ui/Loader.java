...
public class Loader {
  public static void main(String[] args) throws Exception {
    ...
    File libs = new File(System.getProperty("lib.override.dir", "lib"));
    ...
    addUrlMethod.invoke(classLoader, new File(System.getProperty("lib.override.dir", "lib") + "/swt/swt-" + osPart
        + "-" + archPart + ".jar").toURI().toURL());
